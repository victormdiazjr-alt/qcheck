...
function formDayMeta(day) {
  ...
  openForm({
    ...
    fields: [
      ...
      { key: "losas", label: "Cuáles losas", type: "textarea", full: true,
        placeholder: "L3-0.943, L3-0.936, L3-0.929 …",
        hint: "Las que se van a tirar hoy. Si se dejan en blanco solo se ven las que los camiones ya sirvieron." },
      { key: "fase", label: "Fase" },
